...
botao_espada = Botao(207, 411, 336, 79, texto='', imagem=imagem_botao_espada)
botao_magia = Botao(411, 411, 336, 79, texto='', imagem=imagem_botao_magia)
botao_voltar = Botao(411, int(483.15), 336, 79, texto='', imagem=imagem_botao_voltar)
botao_descansar = Botao(int(207.5), int(483.15), 336, 79, texto='', imagem=imagem_botao_descansar)
